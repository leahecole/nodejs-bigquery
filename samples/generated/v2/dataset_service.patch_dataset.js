...
function main(projectId, datasetId, dataset) {
  // [START bigquery_v2_generated_DatasetService_PatchDataset_async]
  /**
  ...
  async function callPatchDataset() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.patchDataset(request);
    console.log(response);
  }

  callPatchDataset();
  // [END bigquery_v2_generated_DatasetService_PatchDataset_async]
}
