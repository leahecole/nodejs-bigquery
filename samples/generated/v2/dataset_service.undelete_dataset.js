...
function main(projectId, datasetId) {
  // [START bigquery_v2_generated_DatasetService_UndeleteDataset_async]
  /**
  ...
  async function callUndeleteDataset() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.undeleteDataset(request);
    console.log(response);
  }

  callUndeleteDataset();
  // [END bigquery_v2_generated_DatasetService_UndeleteDataset_async]
}
