...
function main(projectId, jobId) {
  // [START bigquery_v2_generated_JobService_DeleteJob_async]
  /**
  ...
  async function callDeleteJob() {
    ...
    // Run request
    const response = await bigqueryClient.deleteJob(request);
    console.log(response);
  }

  callDeleteJob();
  // [END bigquery_v2_generated_JobService_DeleteJob_async]
}
