...
function main() {
  // [START bigquery_v2_generated_JobService_InsertJob_async]
  /**
  ...
  async function callInsertJob() {
    // Construct request
    const request = {
    };

    // Run request
    const response = await bigqueryClient.insertJob(request);
    console.log(response);
  }

  callInsertJob();
  // [END bigquery_v2_generated_JobService_InsertJob_async]
}
