...
function main(projectId, datasetId, routineId, routine) {
  // [START bigquery_v2_generated_RoutineService_PatchRoutine_async]
  /**
  ...
  async function callPatchRoutine() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.patchRoutine(request);
    console.log(response);
  }

  callPatchRoutine();
  // [END bigquery_v2_generated_RoutineService_PatchRoutine_async]
}
