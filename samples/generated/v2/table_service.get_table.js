...
function main(projectId, datasetId, tableId) {
  // [START bigquery_v2_generated_TableService_GetTable_async]
  /**
  ...
  async function callGetTable() {
    ...
    // Run request
    const response = await bigqueryClient.getTable(request);
    console.log(response);
  }

  callGetTable();
  // [END bigquery_v2_generated_TableService_GetTable_async]
}
