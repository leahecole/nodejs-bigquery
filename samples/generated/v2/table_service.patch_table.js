...
function main(projectId, datasetId, tableId, table) {
  // [START bigquery_v2_generated_TableService_PatchTable_async]
  /**
  ...
  async function callPatchTable() {
    ...
    // Run request
    const response = await bigqueryClient.patchTable(request);
    console.log(response);
  }

  callPatchTable();
  // [END bigquery_v2_generated_TableService_PatchTable_async]
}
