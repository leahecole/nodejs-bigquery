...
function main(projectId, datasetId, tableId, table) {
  // [START bigquery_v2_generated_TableService_UpdateTable_async]
  /**
  ...
  async function callUpdateTable() {
    ...
    // Run request
    const response = await bigqueryClient.updateTable(request);
    console.log(response);
  }

  callUpdateTable();
  // [END bigquery_v2_generated_TableService_UpdateTable_async]
}
