 ...
 */
var gapicConfig = require("./job_service_client_config.json");
 ...
 * @memberof v2
 */
var JobServiceClient = /** @class */ (function () {
    /**
     ...
     *     ```
     */
    function JobServiceClient(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.v2.JobService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
     ...
     */
    JobServiceClient.prototype.initialize = function () {
        var _this = this;
        ...
        this.jobServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.bigquery.v2.JobService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.bigquery.v2.JobService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        var jobServiceStubMethods = ['cancelJob', 'getJob', 'insertJob', 'deleteJob', 'listJobs', 'getQueryResults', 'query'];
        var _loop_1 = function (methodName) {
            var callPromise = this_1.jobServiceStub.then(function (stub) { return function () {
                var args = [];
        ...
        var this_1 = this;
        for (var _i = 0, jobServiceStubMethods_1 = jobServiceStubMethods; _i < jobServiceStubMethods_1.length; _i++) {
            var methodName = jobServiceStubMethods_1[_i];
            _loop_1(methodName);
        }
        return this.jobServiceStub;
    };
    Object.defineProperty(JobServiceClient, "servicePath", {
        /**
    ...
    Object.defineProperty(JobServiceClient, "apiEndpoint", {
        /**
    ...
    Object.defineProperty(JobServiceClient.prototype, "apiEndpoint", {
        /**
         * The DNS address for this API service.
         * @returns {string} The DNS address for this service.
         */
    ...
    Object.defineProperty(JobServiceClient.prototype, "universeDomain", {
        get: function () {
    ...
    Object.defineProperty(JobServiceClient, "port", {
        /**
    ...
    Object.defineProperty(JobServiceClient, "scopes", {
        /**
     ...
     */
    JobServiceClient.prototype.getProjectId = function (callback) {
        if (callback) {
    ...
    JobServiceClient.prototype.cancelJob = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'job_id': (_b = request.jobId) !== null && _b !== void 0 ? _b : '',
        });
        this.initialize();
        return this.innerApiCalls.cancelJob(request, options, callback);
    };
    JobServiceClient.prototype.getJob = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    JobServiceClient.prototype.insertJob = function (request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    JobServiceClient.prototype.deleteJob = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    JobServiceClient.prototype.listJobs = function (request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    JobServiceClient.prototype.getQueryResults = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    JobServiceClient.prototype.query = function (request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    JobServiceClient.prototype.close = function () {
        var _this = this;
        if (this.jobServiceStub && !this._terminated) {
            return this.jobServiceStub.then(function (stub) {
