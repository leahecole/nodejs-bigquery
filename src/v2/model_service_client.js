 ...
 */
var gapicConfig = require("./model_service_client_config.json");
...
var ModelServiceClient = /** @class */ (function () {
     ...
     *     ```
     */
    function ModelServiceClient(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.v2.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
     ...
     */
    ModelServiceClient.prototype.initialize = function () {
        var _this = this;
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.bigquery.v2.ModelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.bigquery.v2.ModelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        var modelServiceStubMethods = ['getModel', 'listModels', 'patchModel', 'deleteModel'];
        var _loop_1 = function (methodName) {
            var callPromise = this_1.modelServiceStub.then(function (stub) { return function () {
                var args = [];
        ...
        var this_1 = this;
        for (var _i = 0, modelServiceStubMethods_1 = modelServiceStubMethods; _i < modelServiceStubMethods_1.length; _i++) {
            var methodName = modelServiceStubMethods_1[_i];
            _loop_1(methodName);
        }
        return this.modelServiceStub;
    };
    Object.defineProperty(ModelServiceClient, "servicePath", {
        /**
    ...
    Object.defineProperty(ModelServiceClient, "apiEndpoint", {
        /**
    ...
    Object.defineProperty(ModelServiceClient.prototype, "apiEndpoint", {
        /**
         * The DNS address for this API service.
         * @returns {string} The DNS address for this service.
         */
    ...
    Object.defineProperty(ModelServiceClient.prototype, "universeDomain", {
        get: function () {
    ...
    Object.defineProperty(ModelServiceClient, "port", {
        /**
    ...
    Object.defineProperty(ModelServiceClient, "scopes", {
        /**
     ...
     */
    ModelServiceClient.prototype.getProjectId = function (callback) {
        if (callback) {
    ...
    ModelServiceClient.prototype.getModel = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'model_id': (_c = request.modelId) !== null && _c !== void 0 ? _c : '',
        });
        this.initialize();
        return this.innerApiCalls.getModel(request, options, callback);
    };
    ModelServiceClient.prototype.listModels = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    ModelServiceClient.prototype.patchModel = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    ModelServiceClient.prototype.deleteModel = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    ModelServiceClient.prototype.close = function () {
        var _this = this;
        if (this.modelServiceStub && !this._terminated) {
            return this.modelServiceStub.then(function (stub) {
