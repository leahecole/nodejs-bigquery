 ...
 * `src/v2/project_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
var gapicConfig = require("./project_service_client_config.json");
...
var ProjectServiceClient = /** @class */ (function () {
     ...
     *     ```
     */
    function ProjectServiceClient(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.v2.ProjectService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
     ...
     */
    ProjectServiceClient.prototype.initialize = function () {
        var _this = this;
        ...
        this.projectServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.bigquery.v2.ProjectService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.bigquery.v2.ProjectService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        var projectServiceStubMethods = ['getServiceAccount'];
        var _loop_1 = function (methodName) {
            var callPromise = this_1.projectServiceStub.then(function (stub) { return function () {
                var args = [];
        ...
        var this_1 = this;
        for (var _i = 0, projectServiceStubMethods_1 = projectServiceStubMethods; _i < projectServiceStubMethods_1.length; _i++) {
            var methodName = projectServiceStubMethods_1[_i];
            _loop_1(methodName);
        }
        return this.projectServiceStub;
    };
    Object.defineProperty(ProjectServiceClient, "servicePath", {
        /**
    ...
    Object.defineProperty(ProjectServiceClient, "apiEndpoint", {
        /**
    ...
    Object.defineProperty(ProjectServiceClient.prototype, "apiEndpoint", {
        /**
         * The DNS address for this API service.
         * @returns {string} The DNS address for this service.
         */
    ...
    Object.defineProperty(ProjectServiceClient.prototype, "universeDomain", {
        get: function () {
    ...
    Object.defineProperty(ProjectServiceClient, "port", {
        /**
    ...
    Object.defineProperty(ProjectServiceClient, "scopes", {
        /**
     ...
     */
    ProjectServiceClient.prototype.getProjectId = function (callback) {
        if (callback) {
    ...
    ProjectServiceClient.prototype.getServiceAccount = function (request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        var options;
     ...
     */
    ProjectServiceClient.prototype.close = function () {
        var _this = this;
        if (this.projectServiceStub && !this._terminated) {
            return this.projectServiceStub.then(function (stub) {
