...
exports.RoutineServiceClient = void 0;
 ...
 */
var gapicConfig = require("./routine_service_client_config.json");
 ...
 * @memberof v2
 */
var RoutineServiceClient = /** @class */ (function () {
    /**
     ...
     *     ```
     */
    function RoutineServiceClient(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.bigquery.v2.RoutineService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
     ...
     */
    RoutineServiceClient.prototype.initialize = function () {
        var _this = this;
        ...
        this.routineServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.bigquery.v2.RoutineService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.bigquery.v2.RoutineService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        var routineServiceStubMethods = ['getRoutine', 'insertRoutine', 'updateRoutine', 'patchRoutine', 'deleteRoutine', 'listRoutines'];
        var _loop_1 = function (methodName) {
            var callPromise = this_1.routineServiceStub.then(function (stub) { return function () {
                var args = [];
        ...
        var this_1 = this;
        for (var _i = 0, routineServiceStubMethods_1 = routineServiceStubMethods; _i < routineServiceStubMethods_1.length; _i++) {
            var methodName = routineServiceStubMethods_1[_i];
            _loop_1(methodName);
        }
        return this.routineServiceStub;
    };
    Object.defineProperty(RoutineServiceClient, "servicePath", {
        /**
    ...
    Object.defineProperty(RoutineServiceClient, "apiEndpoint", {
        /**
    ...
    Object.defineProperty(RoutineServiceClient.prototype, "apiEndpoint", {
        /**
         * The DNS address for this API service.
         * @returns {string} The DNS address for this service.
         */
    ...
    Object.defineProperty(RoutineServiceClient.prototype, "universeDomain", {
        get: function () {
    ...
    Object.defineProperty(RoutineServiceClient, "port", {
        /**
    ...
    Object.defineProperty(RoutineServiceClient, "scopes", {
        /**
     ...
     */
    RoutineServiceClient.prototype.getProjectId = function (callback) {
        if (callback) {
    ...
    RoutineServiceClient.prototype.getRoutine = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        ...
        options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
            ...
            'routine_id': (_c = request.routineId) !== null && _c !== void 0 ? _c : '',
        });
        this.initialize();
        return this.innerApiCalls.getRoutine(request, options, callback);
    };
    RoutineServiceClient.prototype.insertRoutine = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    RoutineServiceClient.prototype.updateRoutine = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    RoutineServiceClient.prototype.patchRoutine = function (request, optionsOrCallback, callback) {
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    RoutineServiceClient.prototype.deleteRoutine = function (request, optionsOrCallback, callback) {
        var _a, _b, _c;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    RoutineServiceClient.prototype.listRoutines = function (request, optionsOrCallback, callback) {
        var _a, _b;
        request = request || {};
        var options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    RoutineServiceClient.prototype.close = function () {
        var _this = this;
        if (this.routineServiceStub && !this._terminated) {
            return this.routineServiceStub.then(function (stub) {
