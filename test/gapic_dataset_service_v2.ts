  ...
  afterEach(() => {
    ...
    describe('listDatasets', () => {
        it('invokes listDatasets without error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.v2.DatasetList()
            );
        ...
        it('invokes listDatasets without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listDatasets(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.v2.IDatasetList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listDatasets with closed client', async () => {
            const client = new datasetserviceModule.v2.DatasetServiceClient({
              auth: googleAuth,
              projectId: 'bogus',
            });
